...
import photo9 from "../../assets/images/Caroline-Bella/9.jpeg";
import photo10 from "../../assets/images/Caroline-Bella/10.jpeg";
import photo11 from "../../assets/images/Caroline-Bella/11.jpeg";
import photo12 from "../../assets/images/Caroline-Bella/12.jpeg";
import photo13 from "../../assets/images/Caroline-Bella/13.jpeg";
import photo14 from "../../assets/images/Caroline-Bella/14.jpeg";
import photo15 from "../../assets/images/Caroline-Bella/15.jpeg";
import photo16 from "../../assets/images/Caroline-Bella/16.jpeg";
import photo17 from "../../assets/images/Caroline-Bella/17.jpeg";
...
import photo33 from "../../assets/images/Caroline-Bella/33.jpeg";
...
import photo57 from "../../assets/images/Caroline-Bella/57.jpeg";
import photo58 from "../../assets/images/Caroline-Bella/58.jpeg";
import photo59 from "../../assets/images/Caroline-Bella/59.jpeg";
...
import photo65 from "../../assets/images/Caroline-Bella/65.jpeg";
...
import photo70 from "../../assets/images/Caroline-Bella/70.jpeg";
import photo71 from "../../assets/images/Caroline-Bella/71.jpeg";
import photo72 from "../../assets/images/Caroline-Bella/72.jpeg";
import photo73 from "../../assets/images/Caroline-Bella/73.jpeg";
        ...
        <div className="content-container">
          <div id="carousel" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              ...
              <div className="carousel-item">
                <img src={photo9} className="d-block w-100" alt="Slide 9" />
              </div>
              <div className="carousel-item">
                <img src={photo10} className="d-block w-100" alt="Slide 10" />
              </div>
              <div className="carousel-item">
                <img src={photo11} className="d-block w-100" alt="Slide 11" />
              </div>
              <div className="carousel-item">
                <img src={photo12} className="d-block w-100" alt="Slide 12" />
              </div>
              <div className="carousel-item">
                <img src={photo13} className="d-block w-100" alt="Slide 13" />
              </div>
              <div className="carousel-item">
              ...
              <div className="carousel-item">
                <img src={photo16} className="d-block w-100" alt="Slide 16" />
              </div>
              <div className="carousel-item">
                <img src={photo17} className="d-block w-100" alt="Slide 17" />
              </div>
              <div className="carousel-item">
              ...
              <div className="carousel-item">
                <img src={photo29} className="d-block w-100" alt="Slide 29" />
              </div>
              <div className="carousel-item">
              ...
              <div className="carousel-item">
                <img src={photo33} className="d-block w-100" alt="Slide 33" />
              </div>
              <div className="carousel-item">
                <img src={photo34} className="d-block w-100" alt="Slide 34" />
              </div>
              <div className="carousel-item">
                <img src={photo35} className="d-block w-100" alt="Slide 35" />
              </div>
              <div className="carousel-item">
              ...
              <div className="carousel-item">
                <img src={photo48} className="d-block w-100" alt="Slide 48" />
              </div>
              <div className="carousel-item">
              ...
              <div className="carousel-item">
                <img src={photo54} className="d-block w-100" alt="Slide 54" />
              </div>
              <div className="carousel-item">
              ...
              <div className="carousel-item">
                <img src={photo57} className="d-block w-100" alt="Slide 57" />
              </div>
              <div className="carousel-item">
                <img src={photo58} className="d-block w-100" alt="Slide 58" />
              </div>
              <div className="carousel-item">
                <img src={photo59} className="d-block w-100" alt="Slide 59" />
              </div>
              <div className="carousel-item">
              ...
              <div className="carousel-item">
                <img src={photo65} className="d-block w-100" alt="Slide 65" />
              </div>
              <div className="carousel-item">
              ...
              <div className="carousel-item">
                <img src={photo70} className="d-block w-100" alt="Slide 70" />
              </div>
              <div className="carousel-item">
              ...
              <div className="carousel-item">
                <img src={photo73} className="d-block w-100" alt="Slide 73" />
              </div>
              <div className="carousel-item">
